...
Revision ID: f48d4c4035a4
Revises: ffd58baebfb1
Create Date: 2024-09-04 12:39:24.172090
...
revision: str = 'f48d4c4035a4'
down_revision: Union[str, None] = 'ffd58baebfb1'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'invoices', 'templates', ['template_id'], ['id'])
